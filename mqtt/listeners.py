...
from components.scan_preset_select import get_scan_preset_command_topic, on_scan_preset_change
...
def init_listeners() -> None:
	...
	scan_preset_topic = get_scan_preset_command_topic()
	mqttc.subscribe(scan_preset_topic)
	mqttc.message_callback_add(scan_preset_topic, on_scan_preset_change)
