...
def get_scan_all_button_config_topic():
	scan_button_core_topic = scan_all_button_core_topic
	return f"{scan_button_core_topic}/config"

def get_scan_all_button_command_topic():
	scan_button_core_topic = scan_all_button_core_topic
...
def publish_discovery_message_for_scan_all_button():
	discovery_topic = get_scan_all_button_config_topic()
	discovery_payload = ScanButtonDiscoveryPayload(
		name=f"Scan All",
		unique_id=f"scan_all_button",
		device=device_payload,
		command_topic=get_scan_all_button_command_topic(),
	)
